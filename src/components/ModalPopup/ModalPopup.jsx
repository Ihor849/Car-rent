...
const ModalPopup = ({isOpen, onClose,  objectCar,}) => {
  const {id,img, make, year,model,type, rentalPrice, address,description,fuelConsumption,engineSize,accessories,functionalities,rentalCompany,rentalConditions,mileage} =  objectCar;
...
>
    ...
    <ModalContainer>
    {img && (
    <ModalImage src={img} alt="Modal Image" />
    )}
